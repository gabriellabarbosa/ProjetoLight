...
const App = () => {
  ...
  useEffect(() => {
    // Quando chocoalha o celular, muda a cor
  ...
  return (
    ...
    <TouchableOpacity onPress={handleChangeToggle}>
        <Image style = {toggle ? style.lightingOn: style.lightingOff} source ={toggle ? imagex : imagey} />
        <Image style = {style.dioLogo} source ={toggle ? logox : logoy} />
    </TouchableOpacity>
    </View>
  );
};
